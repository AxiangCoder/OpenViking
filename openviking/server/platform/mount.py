...
将 Platform 四组路由（auth/me/admin/platform，05 §12.3–12.6）挂载进真实
...
ProvisioningService；Provisioning 控制面使用 `FakeControlPlane`
（真实 OpenViking namespace 初始化属 P5-E1 初始化阶段，见
provisioning/control_plane.py）。DB 连接使用 platform_config 的
